...
- **v0.4.0** — 微积分 + 概率论全面深度优化：56 课全部对齐权威教材深度（Stewart/Spivak/Chan/Casella-Berger）

### 版本计划

- **v0.5** — 浏览器测试 + QuadraticFormVis 组件 + 概率论交互组件开发
- **v0.6** — 跨课程集成 (统一符号表、前置课链接、进度追踪)
- **v0.7** — 新增专题课程 (均值定理专题、信息论入门、矩母函数专题)
